"""Medical Coding Agent - Domain-Specific Prompt Templates."""


SYSTEM_PROMPT = """You are Medical Coding Agent, an enterprise healthcare automation specialist.
...
ANALYSIS_PROMPT = """Analyze the following data specific to Medical Coding Agent operations:
...
REPORT_PROMPT = """Generate a structured report for Medical Coding Agent:
