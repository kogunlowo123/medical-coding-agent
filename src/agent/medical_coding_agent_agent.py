"""Medical Coding Agent - Main Agent Implementation."""
...
class MedicalCodingAgentAgent:
    ...
    def __init__(self):
        ...
        self._tool_dispatch = {
            "assign_codes": self.tools.assign_codes,
            "validate_codes": self.tools.validate_codes,
            "detect_coding_patterns": self.tools.detect_coding_patterns,
            "calculate_drg": self.tools.calculate_drg,
            "generate_compliance_report": self.tools.generate_compliance_report,
        }
        logger.info(
            "agent_initialized",
            ...
            features=['medical', 'coding', 'compliance', 'interoperability'],
        )
    ...
    async def _maybe_execute_tools(self, message: str, context: str) -> list[dict]:
        ...
        tool_keywords = {
            ...
            "detect_coding_patterns": ['detect', 'coding', 'patterns'],
            "calculate_drg": ['calculate', 'drg'],
