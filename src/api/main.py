"""Medical Coding Agent - FastAPI Application."""
...
app = FastAPI(
    ...
    description="Medical coding agent that assigns ICD-10, CPT, and DRG codes from clinical documentation, validates coding accuracy, detects under/over-coding patterns, and ensures coding compliance.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
